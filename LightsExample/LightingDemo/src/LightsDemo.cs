        ...
        private void CreateLevel()
        {
            ...
            for (int i = 3; i <= 300; i++)
            {
                if (i % 15 == 0)
                {
                    for (int j = 22; j < 25; j++)
                    {
                        Entity level = new Entity(LayerManager.Instance.CreateParallaxLayer(0, 0.7f, true), null, new Vector2(i * Config.GRID, j * Config.GRID), font);
            ...
            for (int i = 3; i <= 300; i++)
            {
                if (i % 20 == 0)
                {
                    for (int j = 18; j < 25; j++)
                    {
                        Entity level = new Entity(LayerManager.Instance.CreateParallaxLayer(0, 0.5f, true), null, new Vector2(i * Config.GRID, j * Config.GRID), font);
