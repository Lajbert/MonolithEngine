...
namespace MonolithEngine
{
    ...
    public partial class LDTKJson
    {
        public static LDTKJson FromJson(string json) => JsonConvert.DeserializeObject<LDTKJson>(json, MonolithEngine.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this LDTKJson self) => JsonConvert.SerializeObject(self, MonolithEngine.Converter.Settings);
    }
