...
namespace MonolithEngine
{
    ...
    public abstract class AbstractAnimation : IAnimation
    {
        ...
        {
            Vector2 pos = Parent == null ? Offset : Parent.DrawPosition + Offset;
            float rot = Parent == null ? 0f : Parent.DrawRotation;
            spriteBatch.Draw(GetTexture(), pos, SourceRectangle, Color, rot, Origin, Scale, SpriteEffect, 0f);
        }
