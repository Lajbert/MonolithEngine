...
namespace MonolithEngine
{
    ...
    public class MultiSelectionImage : Image
    {
        ...
        public MultiSelectionImage(IUIElement parent, Vector2 position = default, Rectangle sourceRectangle = default, float scale = 1f, float rotation = 0f, int depth = 1, Color color = default) : base(null, parent, position, sourceRectangle, scale, rotation, depth, color)
        {
