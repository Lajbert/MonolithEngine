...
namespace MonolithEngine
{
    ...
    public class TextField : AbstractUIElement
    {
        ...
        public TextField(SpriteFont font, Func<string> dataSource, Vector2 position, IUIElement parent, Color color = default, float scale = 1f, float rotation = 0f, float depth = 1) : base (position, parent)
        {
            Font = font;
